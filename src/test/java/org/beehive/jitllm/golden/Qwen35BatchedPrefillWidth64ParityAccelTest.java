 ...
 *
 * <p>Wider than the prompt: a single chunk, most of it inactive. The active count comes from the
 * chunk rather than from the launch width, and this is where that distinction is load-bearing.
 *
