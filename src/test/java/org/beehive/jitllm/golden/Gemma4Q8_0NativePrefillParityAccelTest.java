 ...
 *
 * <p>The envelope is the JIT batched path's, {@link CpuGpuParity#GEMMA4_Q8_0_BATCHED}: the native
 ...
 */
public class Gemma4Q8_0NativePrefillParityAccelTest extends CpuGpuParity {
    ...
    @Test
    public void gemma4E2bQ80NativePrefillParity() throws Exception {
        assumeTrue(
