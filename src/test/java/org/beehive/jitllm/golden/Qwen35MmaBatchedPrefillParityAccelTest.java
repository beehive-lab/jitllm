...
// @formatter:off
/**
 * The batched prefill parity of {@link Qwen35BatchedPrefillParityAccelTest}, with the **tensor-core
 * path actually selected**, and the selection read off the plan the run built.
 *
 ...
 *
 * <p>Width 32 against a 63-token fixture is also the **partial final chunk** case: one full chunk
 * of 32 and one of 31, with the padding rows the MMA store writes and nothing reads.
 */
// @formatter:on
public class Qwen35MmaBatchedPrefillParityAccelTest extends CpuGpuParity {
    ...
    @Test
    public void qwen3_8_27b_q4_0_batchedPrefillParityAt32OnTensorCores() throws Exception {
